...
import ptf_probability_scenarios as proscen
...
def compute_ensemble_sampling_SDE(**kwargs):
    ...
    print(TotProbBS)
    print(' --> Relevant Scenarios BS : ', sampled_ensemble['relevant_scenarios_bs'])
    print(' --> Relevant Scenarios PS : ', sampled_ensemble['relevant_scenarios_ps'])

    print('Number of sampled BS scenarios: ', len(sampled_ensemble['par_scenarios_bs']))
    print('Number of sampled PS scenarios: ', len(sampled_ensemble['par_scenarios_ps']))
    ...
    proscen.save_bs_scenarios_list(par_scenarios_bs = sampled_ensemble['par_scenarios_bs'],
                                   file_bs_list     = file_bs_list)
    
    # saving list of ps scenarios
    proscen.save_ps_scenarios_list(par_scenarios_ps =  sampled_ensemble['par_scenarios_ps'],
                                   Discretizations  = LongTermInfo['Discretizations'],
                                   Regionalization  = Regionalization,
                                   file_ps_list     = file_ps_list)

    # saving probability of scenarios bs and ps
    proscen.save_probability_scenarios(prob_scenarios_bs = sampled_ensemble['ProbScenBS'],

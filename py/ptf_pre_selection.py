...
#                                                BS_mag           = LongTermInfo['Discretizations']['BS-1_Magnitude'])
    ...
    if (pre_selection['BS_scenarios'] == False and pre_selection['PS_scenarios'] == False):
        print(" --> Event magnitude out of the discretization used in PTF. Apply Decision Matrix")
        return False
...
def pre_selection_magnitudes(**kwargs):
    ...
    print(" --> BS magnitude values:       ", *sel_BS_Mag_val)
    print(" --> PS magnitude values:       ", *sel_PS_Mag_val)
    #print(" --> PS magnitude ID:           ", *sel_PS_Mag_IDs)
    #print(" --> BS magnitude ID:           ", *sel_BS_Mag_IDs)
...
#        pre_selection['BS_scenarios'] = False
#        print(" --> Magnitude event outside Magnitude BS scenarios -->", pre_selection['BS_scenarios'])
#    else:
#        pre_selection['BS_scenarios'] = True
#    if(ee['mag_percentiles']['p84'] < PS_mag['Val'][0] or ee['mag_percentiles']['p16'] > PS_mag['Val'][-1]):
#        pre_selection['PS_scenarios'] = False
#        print(" --> Magnitude event outside Magnitude PS scenarios -->", pre_selection['BS_scenarios'])
#
#    else:
#        pre_selection['PS_scenarios'] = True
#

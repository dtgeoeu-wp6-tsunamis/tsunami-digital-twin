...
Python module developed on the basis of the MATLAB function SMOOTH, with the 
aim of removing tide from tsunami time series using a moving average filter. 

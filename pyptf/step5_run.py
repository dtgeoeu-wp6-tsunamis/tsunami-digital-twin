...
def main(**kwargs):
    ...
    # pois = np.load(os.path.join(workdir, 'pois_fixed.npy'), allow_pickle=True).item() #fix cile and tohoku
    ...
    if workflow_dict['ptf_version'] == 'neam':
        ...
        plot_alert_maps_1(pois_coords, pois_al, event_dict, "POIs", logo, 
                             figures_dir, workflow_dict['step5_alert_levels'], logger)
...
def plot_alert_maps_1(points, alert_levels, event_dict, points_label, logo, fdir, fname, logger):
    """
    """
